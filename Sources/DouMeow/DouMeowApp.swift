...
@main
struct DouMeowApp: App {
    @Environment(\.openWindow) private var openWindow
    @StateObject private var appState = AppState()
    @NSApplicationDelegateAdaptor(DouMeowAppDelegate.self) private var appDelegate
        ...
        .commands {
            ...
            CommandGroup(replacing: .appInfo) {
                Button("About \(AppInfo.displayName)") {
                    DouMeowAppContext.shared.openAboutWindow()
                }
            }
...
private struct AppRootView: View {
    ...
    var body: some View {
        RootView()
            ...
            .task {
                DouMeowAppContext.shared.attach(appState: appState)
                DouMeowAppContext.shared.attachWindowActions {
                    openWindow(id: "main")
                } openAboutWindow: {
                    openWindow(id: "about")
                }
