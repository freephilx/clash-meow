...
extension Notification.Name {
    static let douMeowApplicationLogDidAppend = Notification.Name("DouMeowApplicationLogDidAppend")
}
    ...
    private static func publish(_ entry: CoreLogEntry) {
        DispatchQueue.main.async {
            NotificationCenter.default.post(
                name: .douMeowApplicationLogDidAppend,
                object: nil,
...
final class ApplicationLogWriter: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.dou.meow.application-log", qos: .utility)
    ...
    private func trimApplicationLog(_ handle: FileHandle, currentSize: UInt64) throws {
        ...
        let marker = Data("[DouMeow application log truncated]\n".utf8)
