...
final class AppState: ObservableObject {
    ...
    init() {
        ...
        NotificationCenter.default.publisher(for: .douMeowApplicationLogDidAppend)
    ...
    var currentProfile: DouMeowProfileSummary? {
    ...
    func selectProfile(_ profile: DouMeowProfileSummary) async {
    ...
    func refreshProfile(_ profile: DouMeowProfileSummary) async {
    ...
    func deleteProfile(_ profile: DouMeowProfileSummary) async {
        do {
