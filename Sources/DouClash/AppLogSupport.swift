...
extension Notification.Name {
    static let douClashApplicationLogDidAppend = Notification.Name("DouClashApplicationLogDidAppend")
}
    ...
    private static func publish(_ entry: CoreLogEntry) {
        DispatchQueue.main.async {
            NotificationCenter.default.post(
                name: .douClashApplicationLogDidAppend,
                object: nil,
...
final class ApplicationLogWriter: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.dou.clash.application-log", qos: .utility)
    ...
    private func trimApplicationLog(_ handle: FileHandle, currentSize: UInt64) throws {
        ...
        let marker = Data("[DouClash application log truncated]\n".utf8)
