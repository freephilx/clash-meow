...
final class AppState: ObservableObject {
    ...
    @Published var profiles: [DouClashProfileSummary] = []
    ...
    init() {
        ...
        NotificationCenter.default.publisher(for: .douClashApplicationLogDidAppend)
    ...
    var currentProfile: DouClashProfileSummary? {
    ...
    func selectProfile(_ profile: DouClashProfileSummary) async {
    ...
    func refreshProfile(_ profile: DouClashProfileSummary) async {
    ...
    func deleteProfile(_ profile: DouClashProfileSummary) async {
        do {
