...
@main
struct DouClashApp: App {
    @Environment(\.openWindow) private var openWindow
    @StateObject private var appState = AppState()
    @NSApplicationDelegateAdaptor(DouClashAppDelegate.self) private var appDelegate
        ...
        .commands {
            ...
            CommandGroup(replacing: .appInfo) {
                Button("About \(AppInfo.displayName)") {
                    DouClashAppContext.shared.openAboutWindow()
                }
            }
...
private struct AppRootView: View {
    ...
    var body: some View {
        RootView()
            ...
            .task {
                DouClashAppContext.shared.attach(appState: appState)
                DouClashAppContext.shared.attachWindowActions {
                    openWindow(id: "main")
                } openAboutWindow: {
                    openWindow(id: "about")
                }
