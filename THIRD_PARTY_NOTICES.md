...
- Project: https://github.com/jpsim/Yams
- Distributed version: 5.4.0
- License: MIT License
- Copyright: Copyright (c) 2016 JP Simard

The Yams license text is included in the application bundle as
`Contents/Resources/Mihomo/ThirdPartyLicenses/Yams-MIT.txt`.
